...
<div id ="optionsHomePageContent">
    <div class="columnHomePage">
        <div class = "section">
            ...
            <p class = "pageDescription">explanation of purpose of school explorer page (filler text filler text filler text 
    ...
    <div class="columnHomePage">
        <div class = "section">
            <a href="export_download.php"><button class="pageButton"> Export and Download Data</button></a>
            <p class = "pageDescription">explanation of purpose of exports and downloads page (filler text filler text filler text 
                filler text filler text filler text filler text filler text filler text filler text filler text filler text filler 
                text filler text filler text filler text filler text filler text filler text filler text filler text)</p>
        </div>
        <div class = "section">
